...
const OverviewStack = () => {
    ...
    return (
        <Stack.Navigator>
            <Stack.Screen name="Overview" component={Overview} options={({ navigation }) => ({
                headerStyle: {
                    backgroundColor: "#63A088",
                },
                headerTitleStyle: { color: "white" },
                title: 'Overview',
                headerRight: () => (
                    <TouchableOpacity onPress={() => navigation.navigate('AddTransactions')}>
            ...
            <Stack.Screen name="Spending" component={Spending} options={{
                headerStyle: {
                    backgroundColor: "#63A088",
                },
                headerTitleStyle: { color: "white" },
            ...
            <Stack.Screen name="AddTransactions" component={AddTransactions} options={{
                headerStyle: {
                    backgroundColor: "#63A088",
                },
                headerTitleStyle: { color: "white" },
...
const AlertStack = () => {
    return (
        <Stack.Navigator>
            <Stack.Screen name="Alerts" component={Alerts} options={{
                headerStyle: {
                    backgroundColor: "#63A088",
...
const BottomTabNavigator = () => {
    ...
    return (
        <Tab.Navigator >
            <Tab.Screen name="OverviewTab" component={OverviewStack} options={{
                title: 'Overview',
                tabBarIcon: () => <Icon type='ionicon' name='home-outline' />
            }} />
            <Tab.Screen name="AlertsTab" component={AlertStack} options={{
                title: 'Alerts',
                tabBarIcon: () => <Icon type='ionicon' name='notifications-outline' />
            }} />
            <Tab.Screen name="SettingsTab" component={SettingsStack} options={{
                title: 'Settings',
                tabBarIcon: () => <Icon type='ionicon' name='settings-outline' />
            }} />
        </Tab.Navigator>
    );
